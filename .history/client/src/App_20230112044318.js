...
function App() {
	...
	const [chatLog, setChatLog] = useState([
		{
			user: "gpt",
			message: "hey can i help you today?",
		},
		{
			user: "me",
			message: "am i talking to a human or a bot?",
		},
	]);
					...
					>
						<div className="relative flex h-full flex-1 md:flex-col">
							<div className="ml-1 mt-1.5 md:w-full md:m-auto md:flex md:mb-2 gap-2 justify-center">
								<div className="flex flex-col w-full py-2 flex-grow md:py-3 md:pl-4 relative border border-black/10 bg-[#40414f] dark:border-gray-900/50 dark:bg-gray-700 rounded-md shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:shadow-[0_0_15px_rgba(0,0,0,0.10)]">
									<input
	...
	return (
		...
		>
			<div className="chat-message-center  max-w-[640px] mx-auto flex p-[12px]  px-[24px]">
				<div
					className={`chat-avatar bg-[var(--color-primary)] rounded-[50%] w-[40px] h-[40px] ${
						message.user === "gpt" && "chatgpt"
					}`}>
					{message.user === "gpt" && (
						<svg
