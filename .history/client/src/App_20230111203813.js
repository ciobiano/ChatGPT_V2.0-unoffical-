				...
				<div className=" chat-log text-left">
					...
					<div className=" chat-message bg-[var(--text-secondary)]  ">
						<div className="chat-message-center  max-w-[640px] mx-auto flex p-[12px]  px-[24px]">
							<div className="chat-avatar bg-[var(--color-primary)] rounded-[50%] w-[40px] h-[40px] items-center justify-center"></div>
					...
					>
						<div className="relative flex h-full flex-1 md:flex-col">
							<div className="ml-1 mt-1.5 md:w-full md:m-auto md:flex md:mb-2 gap-2 justify-center">
								<div className="flex flex-col w-full py-2 flex-grow md:py-3 md:pl-4 relative border border-black/10 bg-[var(--color-default)]dark:border-gray-900/50 dark:text-white dark:bg-gray-700 rounded-md shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:shadow-[0_0_15px_rgba(0,0,0,0.10)]">
									<input className="w-full h-full px-4 py-2 text-sm text-black placeholder-gray-500 bg-transparent border-none outline-none resize-none"
										rows={1}
										value={input}
...
const ChatMessage = ({ message}) => {
	return (
		<div className={` chat-message ${message.user === "gpt" && "chatgpt"}`}>
			<div className="chat-message-center  max-w-[640px] mx-auto flex p-[12px]  px-[24px]">
				<div
					className={`chat-avatar bg-white rounded-[50%] w-[40px] h-[40px] ${
